...
abstract: |
  ...
  Run that first; here we just plot the data as a figure.
  ...
  In these figures, we can plot:
    ...
    - "mean":   mean climatology of the RACMO variables
    - "stdev":  stdev climatology of the RACMO variables
...
plot_panels <- function() {
  for (ii in 1:6) {
    ...
    # Add title
    kulaR::annotate_kulaBar(above = bquote(.(iiName)), cex = 1.2, 
...
filePath <- paste0(figPath, "fig", params$figName, 
                   "v", sprintf("%02d", vv), "_regressionMaps.pdf")
